...
// Define action types as constants for clarity and reusability
...
function reducer(state, { type, payload }) {
    switch (type) {
        ...
        // Handle clearing the calculator's state
        case ACTIONS.CLEAR:
            return {}
...
// Formatter for displaying operands as integers
...
function App() {
    // Use the reducer to manage calculator state
    ...
    return (
        <div className="calculator-grid">
            ...
            {/* Buttons for various calculator actions */}
